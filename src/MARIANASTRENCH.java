...
import java.io.*;
 ...
 public class MARIANASTRENCH implements questions
 {
  String artist = "MARIANASTRENCH";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("MARIANASTRENCH.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found MT");// Exception if audio file is not found
	 }
   }   
