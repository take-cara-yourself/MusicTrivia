...
import java.io.*;
 ...
 public class NODOUBT implements questions
 {
  String artist = "NODOUBT";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("NODOUBT.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found ND");// Exception if audio file is not found
	 }
   }   
