...
import java.io.*;
 ...
 public class SHAKIRA implements questions
 {
  String artist = "SHAKIRA";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("SHAKIRA.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found SH");// Exception if audio file is not found
	 }
   }   
