...
import java.io.*;
 ...
 public class BLACKEYEDPEAS implements questions
 {
  String artist = "BLACKEYEDPEAS";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("BLACKEYEDPEAS.wav"));// Imports audio file
     MD =  BGM.getData();
