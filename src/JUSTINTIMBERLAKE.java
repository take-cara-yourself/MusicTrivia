...
import java.io.*;
 ...
 public class JUSTINTIMBERLAKE implements questions
 {
  String artist = "JUSTINTIMBERLAKE";
  boolean asked = false;
  
  public JUSTINTIMBERLAKE()
  {
  }
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("JUSTINTIMBERLAKE.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found JT");// Exception if audio file is not found
	 }
   }   
