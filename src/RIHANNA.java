...
import java.io.*;
 ...
 public class RIHANNA implements questions
 {
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("RIHANNA.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found RH");// Exception if audio file is not found
	 }
   }   
