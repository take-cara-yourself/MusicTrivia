...
import java.io.*;
 ...
 public class PITBULL implements questions
 {
  String artist = "PITBULL";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("PITBULL.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found PB");// Exception if audio file is not found
	 }
   }   
