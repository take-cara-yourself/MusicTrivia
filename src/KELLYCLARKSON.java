...
import java.io.*;
 ...
 public class KELLYCLARKSON implements questions
 {
  String artist = "KELLYCLARKSON";
  boolean asked = false;
  
  public KELLYCLARKSON()
  {
  }
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("KELLYCLARKSON.wav"));// Imports audio file
     MD =  BGM.getData();
