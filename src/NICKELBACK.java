...
import java.io.*;
 ...
 public class NICKELBACK implements questions
 {
  String artist = "NICKELBACK";
  boolean asked = false;
  ...
  // Post: If the name is the same returns 1, if not returns 0
   ...
   public void playSound()
   {
    ...
    try
    {
     BGM = new AudioStream(new FileInputStream("NICKELBACK.wav"));// Imports audio file
     MD =  BGM.getData();
	 ...
	 {
	  System.out.println("Error 401 File Not Found NB");// Exception if audio file is not found
	 }
   }   
